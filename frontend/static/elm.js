	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('globalcommands')
					]),
				_List_fromArray(
					[
						A2(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Garden.Model.Msg","aliases":{"Garden.Grid.Model.Cell":{"args":[],"type":"Garden.Grid.Model.CellState"},"Garden.Grid.Model.CellCoords":{"args":[],"type":"( Basics.Int, Basics.Int )"},"Garden.Grid.Model.Grid":{"args":[],"type":"Dict.Dict Garden.Grid.Model.CellCoords Garden.Grid.Model.Cell"},"Array.Tree":{"args":["a"],"type":"Elm.JsArray.JsArray (Array.Node a)"}},"unions":{"Garden.Model.Msg":{"args":[],"tags":{"NoOp":[],"Increment":[],"Decrement":[],"Stop":[],"Go":[],"AddNursery":[],"Move":["Garden.Grid.Model.Direction"],"SetColors":["Array.Array Garden.Display.Model.Plant"],"GridMsg":["Garden.Model.GridName","Garden.Grid.Update.GridMsg"]}},"Array.Array":{"args":["a"],"tags":{"Array_elm_builtin":["Basics.Int","Basics.Int","Array.Tree a","Elm.JsArray.JsArray a"]}},"Garden.Grid.Model.Direction":{"args":[],"tags":{"Left":[],"Right":[],"Up":[],"Down":[]}},"Garden.Grid.Update.GridMsg":{"args":[],"tags":{"NoOp":[],"NewGrid":["Garden.Grid.Model.Grid"],"MkNewGrid":["( Basics.Int, Basics.Int )"],"ToggleCell":["Garden.Grid.Model.CellCoords","Garden.Grid.Model.Cell"]}},"Garden.Model.GridName":{"args":[],"tags":{"Garden":[],"Nursery":[]}},"Garden.Display.Model.Plant":{"args":[],"tags":{"Blue":[],"Pink":[],"Purple":[],"Yellow":[]}},"Garden.Grid.Model.CellState":{"args":[],"tags":{"Alive":[],"Dead":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Elm.JsArray.JsArray":{"args":["a"],"tags":{"JsArray":["a"]}},"Array.Node":{"args":["a"],"tags":{"SubTree":["Array.Tree a"],"Leaf":["Elm.JsArray.JsArray a"]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));